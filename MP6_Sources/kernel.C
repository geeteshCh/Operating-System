...
#ifndef _USES_MIRROR_DISK_
    BlockingDisk * SYSTEM_DISK;
#else
    MirrorDisk * SYSTEM_DISK;
#endif
...
int main() {
    ...
    #else
        SYSTEM_DISK = new MirrorDisk(DISK_ID::MASTER, SYSTEM_DISK_SIZE);
    #endif
    SYSTEM_SCHEDULER->intialize_current_disk(SYSTEM_DISK);
